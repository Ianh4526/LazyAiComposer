#CANT BE USED WE DONT HAVE MP3 FILES
...
#MIDI files in LMD_aligned are aligned to 7 digital preview clips from teh MSD
#Lets listen to this aligned MIDI along with its preview clips
#load in the audio data
audio, fs = librosa.load(msd_id_to_mp3(msd_id))
#Synthesize the audio using Fluidsynth
midi_audio = pm.fluidsynth(fs)
#play audio in oe channel, synthesized MIDI in the other
IPython.display.Audio([midi_audio[:audio.shape[0]]],rate = fs)
